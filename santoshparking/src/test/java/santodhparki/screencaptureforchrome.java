...
//	    driver.navigate().back();
	   ...
	   // driver.findElement(By.xpath("//input[@name='btnK']")).click();
		...
		// Code to copy the screenshot in the desired location
		FileUtils.copyFile(scrFile, new File("C://Users//Home//git//newprojet//santoshparking//src//main//java//santoshparking//screenshot//chrogoogle1.jpg"));
...
//	driver.findElement(By.xpath("//input[@name='btnK']")).click();
	...
	// Code to copy the screenshot in the desired location
	FileUtils.copyFile(scrFile, new File("C://Users//Home//git//newprojet//santoshparking//src//main//java//santoshparking//screenshot//chrogoogle2.jpg"));
